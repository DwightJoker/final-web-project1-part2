		...
		<form action="Controller" method="post">
			...
			<div class="form-group">
				<input type="text" class="input-field"
					placeholder="Имя пользователя" id="name" name="name" required>
			</div>
			<div class="form-group">
				<input type="email" class="input-field" placeholder="Введите email"
					id="loginUsername" name="email" required>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<input type="password" class="input-field"
					placeholder="Подтвердите пароль" id="loginPassword" name="password"
					required>
			</div>

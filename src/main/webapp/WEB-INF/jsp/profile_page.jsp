		...
		<form action="Controller" method="post">
			...
			<div class="form-group">
				...
				<input type="date" class="input-field" 
					placeholder="Дата рождения" id="dateOfBirth" name="dateOfBirth" required>
				<input type="text" class="input-field" 
					placeholder="Пол" id="gender" name="gender" required>	
			</div>
			<div class="form-group">
				<input type="password" class="input-field" placeholder="Пароль"
					id="userPassword" name="password" required>
				<input type="password" class="input-field"
					placeholder="Подтвердите пароль" id="userPassword" name="password"
					required>
			</div>
